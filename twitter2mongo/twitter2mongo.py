...
try:
    # Connect to MongoDB
    pw = "12345."
    cluster = MongoClient('mongodb+srv://user01:'+ pw + '@cluster0-e9d92.mongodb.net/db1?retryWrites=true&w=majority')    
    db = cluster["trends"]
    ...
    auth = tweepy.OAuthHandler("s6ReoDSi9ulYH9v3b7guUE35G", "lzhOBqhHoCIFNC2KVsJG2CQVbavVPzpPwc4EnlVfwQ3qvJ50zo")
    auth.set_access_token("1265255648066969601-FqMGoNogu4GrfXtu8G5UZP2rPrQYUV", "yr2FY2BEKjfT0vcSdw3H2M3TxtevkvjKGB5LAqbz8khxY") 
    api = tweepy.API(auth)
